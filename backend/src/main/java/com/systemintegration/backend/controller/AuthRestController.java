...
import com.systemintegration.backend.dto.AuthResponse;
import com.systemintegration.backend.dto.LoginRequest;
import com.systemintegration.backend.entity.Role;
...
public class AuthRestController {
        ...
        try {
            ...
            if (userRepository.findByUsername(user.getUsername()).isPresent()) {
                return ResponseEntity.badRequest()
                        .body(new AuthResponse("Username already exists", null, null, null, false));
            }
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(new AuthResponse("Registration failed: " + e.getMessage(), null, null, null, false));
        }
    }
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequest) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                    .body(new AuthResponse("Login failed", null, null, null, false));

        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                    .body(new AuthResponse("Login failed: " + e.getMessage(), null, null, null, false));
        }
    }
    ...
    public ResponseEntity<?> getCurrentUser() {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(new AuthResponse("Not authenticated", null, null, null, false));
    }
    ...
    public ResponseEntity<?> logout() {
        ...
        return ResponseEntity.ok(new AuthResponse("Logged out successfully", null, null, null, false));
    }
}